define([pluginJS('validator/GB2260')], function (GB2260) {
    var param = {
        error: {
    ...
    var util = {
        ...
        checkAddr: function (addr, GB2260) {
            return this.getAddrInfo(addr, GB2260);
        }
        // 取得地址码信息
        ,
        ...
        checkBirth: function (birth) {
            ...
            if (year > new Date().getFullYear() || year < 1900 || month > 12 || month < 0 || day > 31 || day < 0) {
                return false;
            }
